      ...
      <div style={{overflowY:'auto  '}}>
        ...
        <div className={styles.main_con}>
          <div className={styles.main_part}>
            <p style={{textIndent:"2em"}}>云宝贝传统文化课程是以《3--6岁儿童学习与发展指南》和教育部印发的《完善中华优秀传统文化教育指导纲要》为指导，以幼儿身心发展规律为基础，为幼儿量身打造的一套传统文化与高科技相渗透、经典故事与操作游戏相结合的教育课程。课程汇集了国内顶级幼儿教育专家团队，精选104个传统文化主题，包含208个活动方案，恰当融入AR技术，更直观地彰显传统文化的光辉灿烂，让幼儿全方位感受中华传统文化的魅力。</p>
            <p>
            云宝贝官网地址：
            <a
